    ...
    <section id="experience" className="py-16 px-6 bg-white/50">
      <div className="max-w-6xl mx-auto">
        ...
        <div className="relative">
          {/* Timeline Line */}
          <div className="hidden md:block absolute top-16 left-0 right-0 h-1 bg-gradient-to-r from-pink-400 via-pink-500 to-amber-500 rounded-full" />
          ...
          <div className="grid grid-cols-1 md:grid-cols-5 gap-6">
            {experiences.map((exp, index) => (
              <div key={index} className="flex flex-col items-center">
                {/* Logo Circle */}
                <div className="w-20 h-20 bg-white rounded-full flex items-center justify-center shadow-lg ring-4 ring-pink-100 mb-4 overflow-hidden z-10">
                  <img
                    src={exp.logo}
                ...
                <div className="hidden md:block w-4 h-4 bg-pink-500 rounded-full ring-4 ring-white shadow-md mb-4" />
